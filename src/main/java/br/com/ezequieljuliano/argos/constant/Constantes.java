...
public class Constantes {
    ...
    public static final String INDICE_EVENTO_HOSTMAC = "INDICE_EVENTO_HOSTMAC";
    public static final String INDICE_EVENTO_SYSUSER = "INDICE_EVENTO_SYSUSER";
    ...
    public static final String INDICE_EVENTO_ENTIDADECODIGO = "INDICE_EVENTO_ENTIDADECODIGO";
    ...
    public static final String INDICE_EVENTO_NIVELCODIGO = "INDICE_EVENTO_NIVELCODIGO";
    ...
    public static final String INDICE_EVENTO_TIPOCODIGO = "INDICE_EVENTO_TIPOCODIGO";
