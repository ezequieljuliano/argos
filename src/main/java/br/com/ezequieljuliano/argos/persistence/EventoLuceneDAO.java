...
public class EventoLuceneDAO implements Serializable {
    ...
    private Document criarDocumento(Evento evento) throws IOException {
        ...
        document.add(new Field(Constantes.INDICE_EVENTO_MENSAGEM, evento.getMensagem(), Store.YES, Index.ANALYZED));
        document.add(new Field(Constantes.INDICE_HOST_NAME, evento.getHostName(), Store.YES, Index.ANALYZED));
        document.add(new Field(Constantes.INDICE_HOST_USER, evento.getHostUser(), Store.YES, Index.ANALYZED));
        document.add(new Field(Constantes.INDICE_HOST_IP, evento.getHostIp(), Store.YES, Index.ANALYZED));
        ...
        document.add(new Field(Constantes.INDICE_OCORRENCIA_DTHR, Data.timestampToString(evento.getOcorrenciaDtHr()), Store.YES, Index.ANALYZED));
        ...
        document.add(new Field(Constantes.INDICE_ENTIDADE_CADASTRONACIONAL, evento.getEntidade().getCadastroNacional(), Store.YES, Index.ANALYZED));
